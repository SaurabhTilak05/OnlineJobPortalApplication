...
export default function Home() {
  ...
  useEffect(() => {
    // Updated 2026-03-13: use the public placements endpoint instead of the admin-only API.
  ...
  return (
    <>
      <motion.section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.7)), url('/images/banner.jpg')",
